...
module Path_state (S : STATE) : sig
  ...
  val counter : Virtual_address.t -> t -> Checkct_options.Address_counter.t option

  (** {2 Modifiers} *)

  val set_counter : Virtual_address.t -> Checkct_options.Address_counter.t -> t -> t
  ...
  val set_address_counters :
    Checkct_options.Address_counter.t Virtual_address.Map.t -> t -> t

...
(** Definition of command-line & programmatic options for CheckCT *)
...
module Taint : Cli.BOOLEAN

module ChosenValues : Cli.BOOLEAN

module Relse : Cli.BOOLEAN

module RelseIsDumb : Cli.BOOLEAN

module StatsFile : Cli.STRING_OPT
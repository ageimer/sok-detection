...
val ymm_reg_to_string : X86Types.xmm_reg -> string
...
val peek_spare : Lreader.t -> int

val read_modrm :
  X86Types.address_size_mode -> Lreader.t -> X86Types.reg32 X86Types.genop * int

val read_modrm_xmm :
  X86Types.address_size_mode ->
  Lreader.t ->
  X86Types.xmm_reg X86Types.genop * int
